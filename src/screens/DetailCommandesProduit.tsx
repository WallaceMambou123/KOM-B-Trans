...
type DetailRouteProp = RouteProp<RootStackParamList, 'DetailCommandesProduit'>;
type DetailNavigationProp = StackNavigationProp<RootStackParamList, 'DetailCommandesProduit'>;

const DetailCommandesProduit = ({
  route,
  navigation,
}: {
...
export default DetailCommandesProduit;